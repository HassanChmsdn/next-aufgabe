...
export default function ProductDetails() {
    ...
    if (!product) {
        return <div>Product Not Fo und</div>
    }
    const addToCartHandler = () => {
        const existItem = state.cart.cartItems.find((x: any) => x.slug === slug)
            ...
            <div className='grid md:grid-cols-4 md:gap-3'>
                ...
                <div>
                    <ul>
                        ...
                        <li>{product.rating} of {product.reviews} reviews</li>
                ...
                <div>
                    <div className='card p-5'>
                        ...
                        <div className='mb-2 flex justify-between'>
                            <div>Status</div>
                            <div>{product.InStock > 0 ? 'In Stock' : 'Unavailable'}</div>
                        </div>
